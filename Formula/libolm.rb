class Libolm < Formula
  ...
  url "https://gitlab.matrix.org/matrix-org/olm/-/archive/3.2.5/olm-3.2.5.tar.gz"
  sha256 "9c7938ce1bb6c46c6712e51341d9e70ed9f875e091bd5c80558f1afddc2d0a11"
  license "Apache-2.0"
  ...
  bottle do
    ...
    sha256 cellar: :any_skip_relocation, x86_64_linux:  "9e45084c5396fd83c5e6031e681686f80d92d8d5a6bc3d772d074a4f5d311eda"
  end
